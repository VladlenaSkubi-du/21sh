...
/*
** Adding the options to the buffer. When it is full,
** it is print
*/
...
/*
** Buffer processing - inserting spaces according to the length of words
...
/*
** Here we calculate the width and the lenght of the buffer
** according to the longest option-word and the terminal width
